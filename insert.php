...
if($_POST["buttonadd"] == "Add") {
    ...
    if ($result) {
        echo "<script>alert('Stoppage added successfully'); window.location = '/gmap';</script>";
    } else {
        echo "<script>alert('Unsuccessfull'); window.location = '/gmap'</script>";
    }
}
    ...
    if ($result) {
        echo "<script>alert('Stoppage Deleted successfully'); window.location = '/gmap';</script>";
    } else {
        echo "<script>alert('Unsuccessfull Deletion'); window.location = '/gmap'</script>";
    }
}
